...
%In the context of his Ph.D. thesis entitled ``A Multi-Paradigm Modeling Approach for Engineering Model Debugging Environments'', he investigated how modeling and simulation formalisms, (visual) environments, and simulators/executors can be enhanced with debugging support. His contributions are related to debugging techniques for model-driven engineering, and simulation.
...
\subsection{Workshop program committee (tentative, to be contacted): cf. CfP in appendix}
